...
const RegistroTrabajador = () => {
  ...
  return (
    <Grid container justify="center" className="adm">
      <h3 className="tituloadm">Registros de Trabajadores</h3>
      <br />
      <Grid item xs={12}>
        <form className="formulario" onSubmit={handleSubmit(onSubmit)}>
          ...
          <input
            ...
            className="form-control text-center"
            name="NombreTrab"
            {...register("NombreTrab", { required: true })}
          ></input>
          {errors.NombreTrab && (
            <span className="text-danger">Se requiere el nombre</span>
          )}
          <br />
          ...
          <input
            ...
            className="form-control text-center"
            name="ApellidosTrab"
            {...register("ApellidosTrab", { required: true })}
          ></input>
          {errors.ApellidosTrab && (
            <span className="text-danger">Se requiren los apellidos</span>
          )}
          <br />
          <label>Número de Teléfono del Trabajador</label>
          <br />
          <input
            type="text"
            className="form-control text-center"
            name="TelefonoTrab"
            {...register("TelefonoTrab", { required: true })}
          ></input>
          {errors.TelefonoTrab && (
            <span className="text-danger">Se requiere el teléfono</span>
          )}
          <br />
