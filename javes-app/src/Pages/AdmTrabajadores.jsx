...
import TableTrabaj from "../Components/TableTrab/TableTrab";
...
const AdmTrabajadores = () => {
            ...
            {trabajador && 
              <form className="formulario" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  ...
                  type="text"
                  name="NombreTrab"
                  defaultValue={trabajador.NombreTrab}
                  {...register("NombreTrab", {})}
                />
                <br />
                ...
                <input
                  ...
                  type="text"
                  name="ApellidosTrab"
                  defaultValue={trabajador.ApellidosTrab}
                  {...register("ApellidosTrab", {})}
                />
                <br />
                ...
                <input
                  ...
                  type="text"
                  name="TelefonoTrab"
                  defaultValue={trabajador.TelefonoTrab}
                  {...register("TelefonoTrab", {})}
                />
                <br />
  ...
  return (
    <Grid container justify="center" className="adm">
      <h3 className="tituloadm">Edición de Trabajadores</h3>
      <br />
      <Grid item xs={12}>
        {isReady ? (
          <TableTrabaj array={trabajadores} handleEditar={handleEditar} />
        ) : (
